...
void start() {
	...
	mainWindow = CreateWindowExW(0, L"SWAGPanel", L"SWAG Clean Version - Payload Panel", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX,
...
"SWAG", MB_YESNO | MB_ICONWARNING) == IDYES) {
